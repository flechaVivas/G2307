...
def superposicion_set(lista_1: Iterable[Any], lista_2: Iterable[Any]) -> bool:
    ...
    """
    #Set: es lo mismo que una lista pero sin elementos repetidos. Con & es la unión de dos sets,
    # con | es la intersección de dos sets y con - es la diferencia de dos sets
